...
$pathImage = '../../../../../uploads/';
$mcImageManagerConfig['filesystem.path'] = $pathImage; // absolute or relative from this script path, optional.
$mcImageManagerConfig['filesystem.rootpath'] = $pathImage; // absolute or relative from this script path, required.
