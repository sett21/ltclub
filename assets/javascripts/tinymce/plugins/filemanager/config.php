...
$mcFileManagerConfig['filesystem.path'] = $pathImage; // absolute or relative from this script path.
$mcFileManagerConfig['filesystem.rootpath'] = $pathImage; // absolute or relative from this script path.
